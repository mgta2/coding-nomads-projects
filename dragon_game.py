# Dragon Game V5
# Take Dragon Game v4 and add features to allow for testing.

import requests # Requires venv to be running
import random

def check_ingred_api():
    url = "https://www.thecocktaildb.com/api/json/v1/1/lookup.php?iid=7"
